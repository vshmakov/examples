...
class CodeController extends Controller
{
    ...
    {
        return $this->render('code/index.html.twig', ['codes' => $codeRepository->findAll()]);
    }
    ...
    {
        return $this->render('code/show.html.twig', ['code' => $code]);
    }
    ...
    public function edit(Request $request, Code $code): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('code_edit', ['id' => $code->getId()]);
        }
