...
class SettingsController extends AbstractController
{
    ...
    {
        return $this->render('settings/index.html.twig', ['settings' => $settingsRepository->findAll()]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        $form = $this->createForm(Settings1Type::class, $setting);
    ...
    {
        return $this->render('settings/show.html.twig', ['setting' => $setting]);
    }
